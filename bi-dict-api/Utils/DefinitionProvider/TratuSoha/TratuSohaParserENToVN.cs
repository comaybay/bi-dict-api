namespace bi_dict_api.Utils.DefinitionProvider.TratuSoha
{
    ...
    public class TratuSohaParserENToVN : TratuSohaParser
    {
        ...
        protected override Sense ParseDefinitionSection(HtmlNode rawDefinitionSection)
        {
            int exampleCount = rawDefinitionSection.SelectNodes("dl/dd/dl/dd")?.Count ?? 0;
            return exampleCount == 1 ? SpecialCase() : NormalCase();

            Sense NormalCase() //Example: Danh từ section in http://tratu.soha.vn/dict/en_vn/smile
            {
            ...
            Sense SpecialCase() //Example: Cấu trúc trừ section in http://tratu.soha.vn/dict/en_vn/smile
            {
